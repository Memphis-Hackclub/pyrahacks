<template>
  <main>
    <div class="image-parent">
      <img src="../assets/computer.png" alt="an image of a computer" />
    </div>
    <div class="content-parent">
      <div class="content">
        <h1>
          A foof, fast-paced online hackathon for anyone benefiting St. Jude
        </h1>
        <div class="buttons">
          <Button
        ...
        <h2>
          Sponsored by
          <a href="https://memphishack.com" target="_blank" rel="nofollow"
            >Memphis Hack Club</a
          >
          and:
        </h2>
